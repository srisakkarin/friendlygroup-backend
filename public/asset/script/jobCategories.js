$(document).ready(function () {
    ...
    $(".productCategoriesSideA").removeClass("activeLi");
    $(".otherSideA").removeClass("activeLi");
    $(".jobCategoriesSideA").addClass("activeLi");
    ...
    $("#categoriesTable").dataTable({
        ...
        ajax: {
            url: `${domainUrl}fetchAllJobCateories`,
            data: function (data) { },
        },
    });
    ...
    $(document).on("submit", "#editGiftForm", function (e) {
        ...
        if (user_type == 1) {
            ...
            $.ajax({
                type: "POST",
                url: `${domainUrl}updateJobCategory`,
                data: formData,
                contentType: false,
                processData: false,
                success: function (response) {
            ...
            swal({
                ...
                if (deleteValue) {
                    if (deleteValue == true) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: `${domainUrl}deleteJobCategory`,
                            dataType: "json",
                            data: {
                                category_id: id,
                            },
