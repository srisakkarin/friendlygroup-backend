$(document).ready(function () {
    ...
    $('#table-22').dataTable({
        ...
        'ajax': {
            'url': `${domainUrl}fetchAllPackages`,
            'data': function (data) {
    ...
    $("#table-22").on("click", ".edit_cats", function (event) {
        ...
        var url = `${domainUrl}getPackagesById` + "/" + id;
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    if (user_type == "1") {
                        ...
                        var delete_cat_url = `${domainUrl}deletePackages` + "/" + cat_id;
