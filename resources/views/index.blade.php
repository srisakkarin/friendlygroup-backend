                        ...
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('All Users') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Total Posts') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Livestream Enabled Users') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Blocked Users') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Live Applications') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Pending Redeems') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Completed Redeems') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Diamond Packs') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Gifts') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Verification Requests') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Interests') }}</h5>
                    ...
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                ...
                                <div class="card-content">
                                    <h5 class="font-13 mt-3">{{ __('Reports') }}</h5>
