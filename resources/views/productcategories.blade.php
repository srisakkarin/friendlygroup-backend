@extends('include.app')
@section('header')
<script src="{{ asset('asset/script/productCategories.js') }}"></script>
@endsection
@section('content')
...
<div class="card">
    <div class="card-header">
        <h4>{{ __('app.product_categories') }}</h4>
        <a class="btn btn-primary addModalBtn ml-auto" data-bs-toggle="modal" data-bs-target="#addGift" href="">{{ __('app.add_category') }}
        </a>
    </div>
    <div class="card-body">
...
<div class="modal fade" id="editGift" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> {{ __('app.Edit_Category') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
