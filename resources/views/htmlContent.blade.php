...
<link rel="stylesheet" href="{{ asset('asset/Trumbowyg/dist/ui/trumbowyg.css') }}">
<meta name="csrf-token" content="{{ csrf_token() }}">
<link rel="stylesheet" href="{{ asset('asset/Trumbowyg/dist/plugins/colors/ui/trumbowyg.colors.css') }}">
<script src="{{ asset('asset/script/htmlContent.js') }}"></script>
<style>
    body {
        margin-top: 20px;
    }
...
<div class="card">
    <div class="card-header d-flex justify-content-start align-items-center">
        <a href="{{ url()->previous() }}" class="mr-2 rounded-circle border d-flex justify-content-center align-items-center text-decoration-none" style="width: 40px; height: 40px; border-color:black">
            <i class="fas fa-arrow-left"></i>
        </a>
        <h4>{{ __('app.html_content') }}</h4>
    </div>
    <div class="card-body">
        <!-- text editer -->
        <div class="" id="html-content">
        ...
        <div class="container flex-grow-1 light-style container-p-y">
            <div class="container-m-nx container-m-ny bg-lightest mb-3">
                ...
                <div class="file-manager-actions container-p-x py-2">
                    <div>
                        <button type="button" id="uploadButton" class="btn btn-primary mr-2"><i class="ion ion-md-cloud-upload"></i>&nbsp; Upload</button>
                        <input type="file" id="fileInput" style="display: none;" accept="image/*,application/pdf,.doc,.docx,.xls,.xlsx,text/plain">
